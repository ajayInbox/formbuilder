...
import FormLinkShare from '@/components/form-share-link'
...
export default async function FormDetailsPage({ params }: {params:{
    id: string,
}}) {
  ...
  return (
    <>
      ...
      <div className='w-full p-8 grid gap-4 grid-cols-1 md:grid-cols-2 lg:grid-cols-4 container'>
        <StatCard
      title="Total visits"
...
async function SubmissionTable({id}: {id: number}){
  ...
  return (
    <>
    <h1 className='text-2xl font-bold my-4'>submissins</h1>
