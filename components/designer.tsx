    ...
    useDndMonitor({
        onDragEnd: (event) =>{
            ...
            if(isDesignerBtnElement && isDroppingOverDesignerDropArea){
                ...
                const newElement = FormElements[type as ElementsType].construc(
                    idGenerator()
                )
            ...
            const droppingSidebarBtnOverDesignerElement = isDroppingOverDesignerElement && isDesignerBtnElement
            ...
            if(droppingSidebarBtnOverDesignerElement){
                ...
                let indexForElement = overElementIndex
                if(isDroppingOverDesignerElementBottomHalf){
                    indexForElement = overElementIndex + 1
                }
                addElement(indexForElement, newElement)
                return
            }
            ...
            if(draggingDesignerElementOverAnotherDesignerElement){
                ...
                addElement(indexForElement, activeElement)
    ...
    <div className='flex w-full h-full'>
        <div className='p-4 w-full' onClick={() => {
            ...
            <div 
                ...
                className={cn('bg-background max-w-[960px] h-full m-auto rounded-xl flex flex-col flex-grow items-center justify-start flex-1 overflow-y-auto',
